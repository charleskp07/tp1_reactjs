...
export default function List() {
  ...
  return (
    <div>
      ...
      <div>
        <Link to="/projects/create">Ajouter un project</Link>
      </div>
      <br />
      {
        isLoading ?
                  ...
                  projects.map((project, index) => {
                    return (
                      <tr key={index}>
                        ...
                        <td>
                          <Link to={`/projects/${project.id}/show`}>Details</Link> | &nbsp;

                          <button type="button" onClick={() => handleDestroyProject(project.id)}>
